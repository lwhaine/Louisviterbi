 ...
 */
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    KC_TAB , KC_PSCR, KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,     KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC,
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, LOWER  , KC_BSPC, KC_SPC ,     KC_SPC , LOWER  , KC_PSCR, KC_DOWN, KC_MUTE, KC_DOWN, KC_RIGHT
  ),
 ...
 */
  [_LOWER] = LAYOUT_ortho_5x14(
    KC_TILD, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 ,
    KC_UNDS, _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,     KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR,
    KC_PLUS, _______, UC(0x391)  , KC_F2  , UC(0x394)  , KC_F4  , UC(0x263)  ,     KC_F6  , KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, _______,
    _______, _______, KC_F7  , KC_F8  , KC_F9  , KC_F10 , UC(0x3B2) ,     KC_F12 , _______, _______, _______, _______, KC_VOLU, _______,
    _______, _______, KC_ALGR, _______, _______, _______, _______,     KC_MPLY, _______, _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
  ),
 ...
 */
  [_RAISE] = LAYOUT_ortho_5x14(
    KC_TILD, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 ,
    KC_UNDS,   KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_LCBR, KC_RCBR,
